# DevOps Portfolio – Aleksander Kirsten
##DevOps Engineer with a background in Computer Science and AI, focused on building and automating cloud infrastructure, CI/CD pipelines and containerized environments.

## 🛠 Core Skills

* **Cloud:** AWS, EKS, EC2, IAM, VPC, S3
* **Containers:** Docker, Kubernetes, Helm
* **Infrastructure as Code:** Terraform, Ansible
* **CI/CD:** Jenkins, Git, Maven, Nexus
* **Monitoring:** Prometheus, Grafana
* **Development:** Python, Bash, Java, JavaScript
